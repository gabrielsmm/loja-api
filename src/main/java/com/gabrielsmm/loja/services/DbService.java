...
import com.gabrielsmm.loja.domain.enums.EstadoPagamento;
...
public class DbService {
	...
	public void instanciaBaseDeDados() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "07593809021", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363567", "93838098"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "49002345", cli2, c2);
